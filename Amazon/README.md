...
- Given an array consisting many inner arrays, flatten the array into one:
 ...
 - Given two sorted linked list, merge both of them into one.
 - Given a connected graph, obtain the critical connections present. Upon removing the critical connections, the graph become disconnected
</br>
